export const uk = {
  auth: {
    ...
    privacyPolicy: {
      ...
      userData1:
        'Ми ніяк не використовуємо ваші дані на GitHub. Після аутентификації токен користувача OAuth зберігається безпосередньо в пам\'ять пристрою. Ми не можемо отримати його. Ми ніколи не переглядаємо токен доступа користувача і не зберігаємо його взагалі.',
      userData2:
  ...
  issue: {
    ...
    pullMerge: {
      ...
      squashAndMerge: 'Об\`єднати і злити',
      merge: 'злити',
      squash: 'об\`єднати',
