export const ru = {
  auth: {
    login: {
      ...
      notificationsMessage: 'Просматривайте и управляйте всеми вашими непрочитанными и активными уведомлениями',
      ...
      issuesMessage: 'Общайтесь, принимайте пулл-реквесты и делайте многое другое',
      signInButton: 'ВОЙТИ',
    },
    welcome: {
      welcomeTitle: 'Добро пожаловать в GitPoint',
    ...
    privacyPolicy: {
      ...
      userData1: 'Мы никак не используем ваши данные на GitHub. После аутентификации токен пользователя OAuth сохраняется непосредственно в хранилище устройства. Мы не можем получить его. Мы никогда не просматриваем токен доступа пользователя и не храним его вообще.',
