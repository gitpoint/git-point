export const gl = {
  auth: {
    ...
    events: {
      ...
      actions: {
        ...
        deleted: 'eliminaches',
        assigned: 'asignaches',
        unassigned: 'retiraches',
        labeled: 'etiquetaches',
        unlabeled: 'desetiquetaches',
        opened: 'abriches',
        milestoned: 'marcaches',
        demilestoned: 'desmarcaches',
        closed: 'fechado',
        reopened: 'reaberto',
        review_requested: 'revisión solicitada',
        review_request_removed: 'solicitude de revisión retirada',
        submitted: 'enviaches',
        dismissed: 'rexeitado',
        published: 'publicado',
        publicized: 'feito público',
        privatized: 'feito privado',
        starred: 'engadido a favoritos',
        pushedTo: 'fixeches push para ',
        forked: 'fixeches fork de',
        commented: 'comentaches',
        removed: 'quitaches',
      },
    },
    profile: {
  ...
  repository: {
    main: {
      ...
      unwatchAction: 'Deixar de Vixilar',
      watchAction: 'Vixilar',
      ...
      noPullRequestsMessage: 'Ningunha pull requests',
      noOpenPullRequestsMessage: 'Ningunha pull requests aberta',
      starsTitle: 'Favorito',
      forksTitle: 'Forks',
