...
class Login extends Component {
  ...
  githubOauth(client_id, callback) {
    ...
    Linking.openURL(`https://github.com/login/oauth/authorize?response_type=token&client_id=${client_id}&redirect_uri=gitpoint://home&scope=user%20repo&state=${stateRandom}`);
  }
  ...
  render() {
    ...
    return (
      <View>
        { !isAuthenticated && this.state.asyncStorageChecked &&
            <View>
              <Image style={styles.imageContainer} source={require('../images/login-background.png')}>
